...
class ReportAPITests(APITestCase):
    ...
    admin_token = None
    EFO_URL = (
        f'/{settings.SITE_ROOT()}report/enrolled_families/pdf/'
        '?locationId=34&dateFrom=2019-04-01&dateTo=2019-04-30'
    )
    IFO_URL = (
        f'/{settings.SITE_ROOT()}report/insuree_family_overview/pdf/'
        '?dateFrom=2023-11-01&dateTo=2023-12-31'
    )
    IMP_URL = f'/{settings.SITE_ROOT()}report/insuree_missing_photo/pdf/'
    IME_URL = (
        f'/{settings.SITE_ROOT()}report/insurees_pending_enrollment/pdf/'
        '?dateFrom=2019-04-01&dateTo=2019-04-30&officerId=1&locationId=20'
    )
